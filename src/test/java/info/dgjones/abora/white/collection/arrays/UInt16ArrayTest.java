...
public class UInt16ArrayTest extends TestCase {
	...
	public void testZeroElements() {
		...
		// zero all elements
		array = UInt16Array.make(1);
		array.storeUInt16(0, (char)1);
		array.zeroElements(0, -1);
		AssertArrays.assertEquals(UInt16Array.make(new char[] {0}), array);

		array = AssertArrays.makeUInt16Array12345();
		array.zeroElements();
		AssertArrays.assertEquals(UInt16Array.make(new char[] {0, 0, 0, 0, 0}), array);
		...
		AssertArrays.assertEquals(UInt16Array.make(new char[] {1, 0, 0, 0, 0}), array);
		...
		AssertArrays.assertEquals(UInt16Array.make(new char[] {1, 2, 3, 4, 0}), array);
