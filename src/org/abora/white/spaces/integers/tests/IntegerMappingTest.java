...
import org.abora.white.tumbler.IEEE32Pos;
...
public class IntegerMappingTest extends TestCase {
	...
	public void testPrintOn() {
		IntegerMapping mapping = IntegerMapping.make();
		assertEquals("org.abora.white.spaces.integers.IntegerMapping(0)", mapping.toString());		

		mapping = IntegerMapping.make(IntegerValue.make(-1));
		assertEquals("org.abora.white.spaces.integers.IntegerMapping(-1)", mapping.toString());		
