...
public class IEEE32ArrayTest extends TestCase {
	...
	public void testMakePrimArray() {
		IEEE32Array made = IEEE32Array.make(AssertArrays.makeIEEE32ArrayEmpty());
		AssertArrays.assertEquals(AssertArrays.makeIEEE32ArrayEmpty(), made);
		
		made = IEEE32Array.make(AssertArrays.makeIEEE32Array12345());
		AssertArrays.assertEquals(AssertArrays.makeIEEE32Array12345(), made);
	}
	...
	public void testIndexOf() {		
		int index = AssertArrays.makeIEEE32ArrayEmpty().indexOf(IEEE32Value.make(1.1f), 0, 1);
		assertEquals(-1, index);

		index = AssertArrays.makeIEEE32Array1().indexOf(IEEE32Value.make(1.1f), 0, 1);
		assertEquals(0, index);

		index = AssertArrays.makeIEEE32Array1().indexOf(IEEE32Value.make(1.1f), 0, 0);
		assertEquals(-1, index);
		
		index = AssertArrays.makeIEEE32Array12345().indexOf(IEEE32Value.make(1.1f), 0, 1);
		assertEquals(0, index);

		index = AssertArrays.makeIEEE32Array12345().indexOf(IEEE32Value.make(1.1f), 0, 2);
		assertEquals(-1, index);

		index = AssertArrays.makeIEEE32Array12345().indexOf(IEEE32Value.make(1.1f), 1, 1);
		assertEquals(-1, index);

		index = AssertArrays.makeIEEE32Array12345().indexOf(IEEE32Value.make(5.5f), 0, 1);
		assertEquals(4, index);
		
		index = AssertArrays.makeIEEE32Array12321().indexOf(IEEE32Value.make(2.2f), 0, 1);
		assertEquals(1, index);

		index = AssertArrays.makeIEEE32Array12321().indexOf(IEEE32Value.make(2.2f), 0, 2);
		assertEquals(3, index);

		index = AssertArrays.makeIEEE32Array12321().indexOf(IEEE32Value.make(1.1f), -1, -1);
		assertEquals(4, index);

		index = AssertArrays.makeIEEE32Array12321().indexOf(IEEE32Value.make(2.2f), -1, -1);
		assertEquals(3, index);

		index = AssertArrays.makeIEEE32Array12321().indexOf(IEEE32Value.make(2.2f), -1, 1);
		assertEquals(-1, index);

		index = AssertArrays.makeIEEE32Array12321().indexOf(IEEE32Value.make(2.2f), -1, -2);
		assertEquals(1, index);

		index = AssertArrays.makeIEEE32Array12321().indexOf(IEEE32Value.make(2.2f), -1, -3);
		assertEquals(-1, index);

		index = AssertArrays.makeIEEE32Array12321().indexOf(IEEE32Value.make(2.2f), -3, -1);
		assertEquals(1, index);
		...
		try {
			AssertArrays.makeIEEE32Array12321().indexOf(IEEE32Value.make(2.2f), -6, 1);
			fail();
		} catch (IndexOutOfBoundsException e) {
			// expected
		}
		...
		try {
			AssertArrays.makeIEEE32Array12321().indexOf(IntegerValue.make(2), -3, 1);
			fail();
		} catch (ClassCastException e) {
			// expected
		}
	...
	public void testIndexPast() {		
		int index = AssertArrays.makeIEEE32ArrayEmpty().indexPast(IEEE32Value.make(1.1f), 0, 1);
		assertEquals(-1, index);

		index = AssertArrays.makeIEEE32Array1().indexPast(IEEE32Value.make(1.1f), 0, 1);
		assertEquals(-1, index);

		index = AssertArrays.makeIEEE32Array1().indexPast(IEEE32Value.make(1.1f), 0, 0);
		assertEquals(-1, index);
		
		index = AssertArrays.makeIEEE32Array12345().indexPast(IEEE32Value.make(1.1f), 0, 1);
		assertEquals(1, index);

		index = AssertArrays.makeIEEE32Array12345().indexPast(IEEE32Value.make(1.1f), 0, 2);
		assertEquals(2, index);

		index = AssertArrays.makeIEEE32Array12345().indexPast(IEEE32Value.make(1.1f), 1, 1);
		assertEquals(1, index);

		index = AssertArrays.makeIEEE32Array12345().indexPast(IEEE32Value.make(5.5f), 0, 1);
		assertEquals(0, index);

		index = AssertArrays.makeIEEE32Array12345().indexPast(IEEE32Value.make(5.5f), 3, 1);
		assertEquals(3, index);

		index = AssertArrays.makeIEEE32Array12345().indexPast(IEEE32Value.make(5.5f), 4, 1);
		assertEquals(-1, index);
		
		index = AssertArrays.makeIEEE32Array12321().indexPast(IEEE32Value.make(2.2f), 0, 1);
		assertEquals(0, index);

		index = AssertArrays.makeIEEE32Array12321().indexPast(IEEE32Value.make(2.2f), 0, 2);
		assertEquals(2, index);

		index = AssertArrays.makeIEEE32Array12321().indexPast(IEEE32Value.make(1.1f), -1, -1);
		assertEquals(3, index);

		index = AssertArrays.makeIEEE32Array12321().indexPast(IEEE32Value.make(2.2f), -1, -1);
		assertEquals(4, index);

		index = AssertArrays.makeIEEE32Array12321().indexPast(IEEE32Value.make(2.2f), -1, 1);
		assertEquals(4, index);

		index = AssertArrays.makeIEEE32Array12321().indexPast(IEEE32Value.make(2.2f), -1, 2);
		assertEquals(-1, index);

		index = AssertArrays.makeIEEE32Array12321().indexPast(IEEE32Value.make(2.2f), -1, -2);
		assertEquals(2, index);

		index = AssertArrays.makeIEEE32Array12321().indexPast(IEEE32Value.make(2.2f), -1, -3);
		assertEquals(0, index);

		index = AssertArrays.makeIEEE32Array12321().indexPast(IEEE32Value.make(2.2f), -3, -1);
		assertEquals(2, index);
		...
		try {
			AssertArrays.makeIEEE32Array12321().indexPast(IEEE32Value.make(2.2f), -6, 1);
			fail();
		} catch (IndexOutOfBoundsException e) {
			// expected
		}
