...
import org.abora.white.collection.tables.OberIntegerTable;
...
public class ITDescendingStepper extends IntegerTableStepper {
	...
	*/
	...
	public Stepper copy() {
		return new ITDescendingStepper(((ActualIntegerTable) arrayInternal.copy()), index(), arrayInternal.startIndex().plus(IntegerValue.make(lastValueInternal)));
		/*
	...
	public ITDescendingStepper(OberIntegerTable array, IntegerValue index) {
		super();
		arrayInternal = (OberIntegerTable) array.copy();
	...
	public ITDescendingStepper(OberIntegerTable array, IntegerValue start, IntegerValue stop) {
		super();
		arrayInternal = (OberIntegerTable) array.copy();
