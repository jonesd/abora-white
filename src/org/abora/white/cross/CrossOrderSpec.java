...
import org.abora.white.spaces.cross.GenericCrossSpace;
...
public class CrossOrderSpec extends OrderSpec {
	...
	*/
	...
	public boolean isFullOrder(XnRegion keys) {
		return false;
		/* any 2 d or greater space has no fullordering */
		/* TODO Someone shouldImplement. */
		/* fodder */
		/*
...
//	public static Heaper make(Object space, Object subOrderings) {
//		return make().space().with(subOrderings, null);
//		/*
